...
/**
 * fishBiomass: A geoprocessing function that calculates overlap metrics for vector datasources
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function fishBiomass(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("fishBiomass");
...
export default new GeoprocessingHandler(fishBiomass, {
  title: "fishBiomass",
  description: "",
  timeout: 500, // seconds
