...
/**
 * fishDensity: A geoprocessing function that calculates overlap metrics for vector datasources
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function fishDensity(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("fishDensity");
...
export default new GeoprocessingHandler(fishDensity, {
  title: "fishDensity",
  description: "",
  timeout: 500, // seconds
