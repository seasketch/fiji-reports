              ...
              >
                <p>
                  <Trans i18nKey="Mangroves 1">
                    This report summarizes overlap with mangrove extent, based
                    on Global Mangrove Watch data.
                  </Trans>
                </p>
                ...
                <Collapse
                  title={t("Learn More")}
                  key={props.printing + "Mangroves Learn More Collapse"}
                ...
                >
                  <Trans i18nKey="Mangroves - learn more">
                    ...
                    <p>
                      ...
                      total area of mangroves to obtain the % contained within
                      the zone. Only mangroves which fall within the planning
                      region are counted in this report.
                    </p>
                  </Trans>
                </Collapse>
              </ToolbarCard>
